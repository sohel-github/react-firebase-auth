    ...
    <div className='flex justify-center items-center h-screen'>
      <div className="mx-auto w-full max-w-md bg-white rounded-2xl shadow-lg p-8">
        ...
        <form action="#" method="POST" className="space-y-5">
          ...
          <button class="flex w-full items-center justify-center space-x-2 border border-gray-300 rounded-lg px-4 py-2 bg-white text-gray-700 hover:bg-gray-100 transition">
            <img src="https://www.gstatic.com/firebasejs/ui/2.0.0/images/auth/google.svg" alt="Google Logo" class="w-5 h-5" />
            <span>Sign in with Google</span>
          </button>

          <button class="flex w-full items-center justify-center space-x-2 bg-[#377fe5] hover:bg-[#165cdb] text-white px-4 py-2 rounded-lg transition">
          ...
          <button class="flex w-full items-center justify-center space-x-2 bg-gray-900 hover:bg-black text-white px-4 py-2 rounded-lg transition">
            <svg class="w-5 h-5 fill-current" viewBox="0 0 24 24" aria-hidden="true">
              <path
